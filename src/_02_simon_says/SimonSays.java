...
public class SimonSays extends KeyAdapter {
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == imageIndex && simonSays == true) {
			score += 1; // 17. Increase the value of score
			speak("You are correct"); // 18. Use the speak method to tell the user they were correct
		}else if(e.getKeyCode() != imageIndex && simonSays == false){ // 19. If the keyCode doesn't match the imageIndex and "Simon didn't say..."
			score += 1; // 20. Increase the value of score
			speak("You are correct"); // 21. Use the speak method to tell the user they were correct
		}
		// 22. Increment tries by 1
		tries += 1;
		// 25. If tries is greater than 9 (or however many you want)...
		if (tries > 9) {
			speak("Score: " + score); // 26. Tell the user their score
			System.exit(0); // 27. Exit the program
			frame.dispose(); // 23. Dispose of the frame
		}
